	...
	<div id="bppfa-whats-new-content">
		<div id="whats-new-textarea">
			...
			?>
				...
				<textarea class="bp-suggestions" name="whats-new" id="bppfa-whats-new" cols="50" rows="10" <?php if ( bp_is_group() ) : ?> data-suggestions-group-id="<?php echo esc_attr( (int) bp_get_current_group_id() ); ?>" <?php endif; ?> ><?php if ( isset( $_GET['r'] ) ) : //phpcs:ignore?><?php echo esc_html( sanitize_text_field( wp_unslash( $_GET['r'] ) ) ); endif; ?></textarea>
		</div>
