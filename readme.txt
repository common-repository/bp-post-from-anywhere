...
BuddyPress Post from Anywhere allows you to post activities for BuddyPress or BuddyBoss Platform using shortcodes from any page or any CPT post.

With BuddyPress by default, posting to activity is possible only from the Activity tab of a member’s profile page. However, BuddyPress Post from anywhere lets you add what’s a new section to any of your posts, pages, or template files.

You can also use the shortcode [bppfa_postform] at pages or inside template files.
...
= Does this plugin provide any shortcode?  =

Use shortcode [bppfa_postform] to list BP Post From Anywhere interface at any custom page.
...
1. It is displaying Post Form After adding shortcode in page/posts screenshot-1.png
2. It is displaying Post Form After adding widgets screenshot-2.png

== Changelog ==
= 1.5.2 =
* Fix: phpcs issue
= 1.5.1 =
* Fix: (#50) Fixed when update activity not showing messages without any text

= 1.5.0 =
* Fix: phpcs issue
* Fix: textarea issue
* Fix: white space issue
* Fix: (#46) Fixed remove white space from post form textarea

= 1.4.0 =
* Fix: #37 Fixed PHPCS Errors
* Fix: Update bppfa_site_url to bppfa_url
* Fix: Group post not submit in group and also fixed broken image issue

= 1.3.0 =
* Fix: (#32) Fixed shortcode layout conflict for buddy boss dashboard page
* Fix: Update bp-post-from-anywhere-public.js
* Fix: success message icon alignment fixed
* Fix: Update plugin url path

= 1.2.0 =
* Fix: Fixed Load Newest Activity count issue
* Fix: Removed Post from Anywhere widget
* Fix: Update activity post form UI, added missing icons images
* Fix: Fixed White space issue in text area
* Fix: Fixed shortcode html issue in admin side
* Fix: Fixed: Activity Post any where to submit activity
* Fix: Added extended option filter to enable to display additional option
* Fix: Fixed #19 - Post button do not work
* Fix: Fixed #21 - The cursor starts from the middle of the text box

= 1.1.0 =
* Fix: Admin notice for review
= 1.0.1 =
